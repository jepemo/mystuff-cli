...
def test_eval_commands():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            add_or_update_evaluation("2023-10-05", "productivity", 8, "Very productive day")
            add_or_update_evaluation("2023-10-05", "health", 7, "Went for a run")
            add_or_update_evaluation("2023-10-06", "productivity", 6, "Good but could be better")
            add_or_update_evaluation("2023-11-01", "productivity", 9, "Excellent focus")
            
            # Test 2: Find evaluation
            print("2. Finding evaluation...")
            eval_entry = find_evaluation_by_date_and_category("2023-10-05", "productivity")
            ...
            add_or_update_evaluation("2023-10-05", "productivity", 9, "Actually, it was excellent")
            updated_eval = find_evaluation_by_date_and_category("2023-10-05", "productivity")
            ...
            october_evals = filter_evaluations_by_date_range(all_evals, "2023-10-01", "2023-10-31")
