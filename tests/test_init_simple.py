...
def test_init_create_default_structure():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert links_file.exists(), "links.jsonl file was not created"
        assert links_file.is_file(), "links.jsonl is not a file"
        ...
        assert config_file.exists(), "config.yaml file was not created"
        assert config_file.is_file(), "config.yaml is not a file"
