...
def test_meeting_add_default_date():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        result = runner.invoke(
            app,
            ["meeting", "add", "--title", "Quick Meeting", "--body", "Test meeting"],
            env=env,
            input="n\n",
        )  # Don't edit
...
def test_meeting_delete_nonexistent():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        result = runner.invoke(
            app, ["meeting", "delete", "--title", "Non-existent Meeting"], env=env
        )
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        result = runner.invoke(
            ...
            [
                ...
                "add",
                "--title",
                "Team Meeting: Q4 Review & Planning (2023)",
                "--date",
                "2023-10-05",
                "--body",
                "Quarterly review",
        ...
        meetings_dir = test_dir / "meetings"
        meeting_file = (
            meetings_dir / "2023-10-05_team-meeting-q4-review-planning-2023.md"
        )
        assert meeting_file.exists()
